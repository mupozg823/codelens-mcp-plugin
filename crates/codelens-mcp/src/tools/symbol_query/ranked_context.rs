...
struct RankFusionPolicy {
    semantic_limit: usize,
    semantic_insertion_floor: f64,
    semantic_added_score_cap: i32,
    semantic_boosted_score_cap: i32,
    sparse_limit: usize,
    sparse_insertion_floor: i32,
}

fn rank_fusion_policy(query: &str, max_semantic: usize, max_sparse: usize) -> RankFusionPolicy {
...
fn merge_sparse_ranked_entries(
    query: &str,
    result: &mut RankedContextResult,
