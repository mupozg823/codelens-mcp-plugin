...
fn full_response(input: PrepareHarnessResponseInput<'_>) -> Result<Value, CodeLensError> {
    ...
    Ok(json!({
        ...
        "visible_tools": {
            ...
            "execution_classes": &input.routing.visible_execution_class_counts,
        ...
        "routing": {
            ...
            "preferred_entrypoints_with_policies": &input.routing.preferred_entrypoints_with_policies,
            "recommended_entrypoint": &input.routing.recommended_entrypoint,
            "recommended_entrypoint_execution_policy": &input.routing.recommended_entrypoint_execution_policy,
        },
        "harness": {
