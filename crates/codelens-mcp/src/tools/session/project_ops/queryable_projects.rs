...
pub(crate) fn list_queryable_projects(
    state: &AppState,
...
pub(crate) fn add_queryable_project(state: &AppState, arguments: &serde_json::Value) -> ToolResult {
...
pub(crate) fn remove_queryable_project(
    state: &AppState,
...
pub(crate) fn query_project(state: &AppState, arguments: &serde_json::Value) -> ToolResult {
