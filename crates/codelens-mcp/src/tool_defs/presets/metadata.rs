...
pub(crate) fn tool_deprecation(name: &str) -> Option<(&'static str, &'static str, &'static str)> {
    match name {
        ...
        // Phase 0 diet: unused tools with no integration test or host routing
        "analyze_missing_imports" => Some(("1.13.27", "get_file_diagnostics", "v2.0")),
        "audit_tool_surface_consistency" => Some(("1.13.27", "get_current_config", "v2.0")),
        "find_orphan_handlers" => Some(("1.13.27", "find_referencing_symbols", "v2.0")),
        "find_over_visible_apis" => Some(("1.13.27", "get_symbols_overview", "v2.0")),
        "find_phantom_modules" => Some(("1.13.27", "module_boundary_report", "v2.0")),
        "find_redundant_definitions" => Some(("1.13.27", "find_code_duplicates", "v2.0")),
        "get_project_structure" => Some(("1.13.27", "onboard_project", "v2.0")),
        "prepare_for_new_conversation" => Some(("1.13.27", "prepare_harness_session", "v2.0")),
        "retry_analysis_job" => Some(("1.13.27", "start_analysis_job", "v2.0")),
        "summarize_changes" => Some(("1.13.27", "review_changes", "v2.0")),
        "summarize_file" => Some(("1.13.27", "read_file", "v2.0")),
        "check_lsp_status" => Some(("1.13.27", "get_lsp_recipe", "v2.0")),
        "find_circular_dependencies" => Some(("1.13.27", "module_boundary_report", "v2.0")),
        "find_relevant_rules" => Some(("1.13.27", "find_referencing_symbols", "v2.0")),
        "get_change_coupling" => Some(("1.13.27", "get_impact_analysis", "v2.0")),
        "search_for_pattern" => Some(("1.13.27", "bm25_symbol_search", "v2.0")),
        "semantic_code_review" => Some(("1.13.27", "review_changes", "v2.0")),
        _ => None,
    }
}
