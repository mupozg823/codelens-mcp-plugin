...
fn build_tools() -> Vec<Tool> {
    ...
    #[cfg(feature = "semantic")]
    {
        ...
        tools.push(Tool::new("index_embeddings", "[CodeLens:Symbol] Build semantic embedding index. Required before semantic_search.", json!({"type":"object","properties":{"prewarm_queries":{"type":"array","items":{"type":"string"},"description":"Optional semantic queries to precompute into the durable query embedding cache"},"prewarm_limit":{"type":"integer","description":"Maximum prewarm queries to accept (default 128, max 1024)"}}})).with_annotations(ro.clone()));
