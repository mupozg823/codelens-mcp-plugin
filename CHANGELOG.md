...
- **Measurement** (Phase 2h, 2026-04-12, same infrastructure as §8.7 / §8.8):
  ...
  - **Python requests**: strict + stacked hybrid MRR **0.5021** vs the §8.8 stacked arm at 0.4948 — a **+0.0073 partial recovery** (≈ 8 % of the §8.8 regression closed). `semantic_search` MRR +0.0089, NL hybrid MRR +0.0103. Accuracy metrics (Acc@1 / Acc@3 / short_phrase Acc@3) are unchanged — the filter is improving the _confidence_ of the right answer's rank, not moving it across bucket boundaries.
