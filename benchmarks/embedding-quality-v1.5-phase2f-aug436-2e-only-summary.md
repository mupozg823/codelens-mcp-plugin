...
|---|---:|---:|---:|---:|---:|
| semantic_search | 0.046 | 4% | 5% | 6% | 233.2 |
| get_ranked_context_no_semantic | 0.045 | 4% | 5% | 6% | 31.5 |
| get_ranked_context | 0.049 | 4% | 6% | 6% | 112.4 |

## Query Type Breakdown

| Method | Query type | Count | MRR | Acc@1 | Acc@3 | Acc@5 | Avg ms |
|---|---|---:|---:|---:|---:|---:|---:|
| semantic_search | identifier | 83 | 0.096 | 10% | 10% | 10% | 128.9 |
| semantic_search | natural_language | 299 | 0.037 | 3% | 4% | 5% | 264.3 |
| semantic_search | short_phrase | 54 | 0.021 | 2% | 2% | 2% | 221.7 |
| get_ranked_context_no_semantic | identifier | 83 | 0.096 | 10% | 10% | 10% | 22.8 |
| get_ranked_context_no_semantic | natural_language | 299 | 0.038 | 3% | 5% | 5% | 34.0 |
| get_ranked_context_no_semantic | short_phrase | 54 | 0.005 | 0% | 0% | 2% | 31.0 |
| get_ranked_context | identifier | 83 | 0.096 | 10% | 10% | 10% | 23.0 |
| get_ranked_context | natural_language | 299 | 0.039 | 3% | 5% | 5% | 134.1 |
| get_ranked_context | short_phrase | 54 | 0.028 | 2% | 4% | 4% | 130.1 |
...
| get_ranked_context | paginate database query results | miss | query_results (scripts/finetune/bench_external.py) |
