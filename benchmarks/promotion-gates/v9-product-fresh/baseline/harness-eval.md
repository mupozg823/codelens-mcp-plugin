...
| Rust MCP repo | impact/reviewer | baseline | synthetic | True | None | None | - | 2972 | 0 | 3 | 3 | 282 | prefer_codelens_after_bootstrap |
| Rust MCP repo | impact/reviewer | naive-on | synthetic | True | None | None | - | 400 | 0 | 1 | 0 | 452 | prefer_codelens_after_bootstrap |
...
| Rust MCP repo | onboarding/planning | baseline | synthetic | True | None | None | - | 2621 | 0 | 2 | 2 | 186 | prefer_codelens_after_bootstrap |
| Rust MCP repo | onboarding/planning | naive-on | synthetic | True | None | None | - | 482 | 0 | 1 | 0 | 699 | prefer_codelens_after_bootstrap |
...
| Rust MCP repo | refactor preflight | baseline | synthetic | True | None | None | - | 938 | 0 | 3 | 3 | 533 | prefer_codelens_after_bootstrap |
| Rust MCP repo | refactor preflight | naive-on | synthetic | True | None | None | - | 477 | 0 | 1 | 0 | 2757 | prefer_codelens_after_bootstrap |
...
| Rust MCP repo | simple local lookup/edit | naive-on | synthetic | True | None | None | - | 8718 | 0 | 3 | 0 | 193 | avoid_codelens_for_simple_local_lookup |
...
- Rust MCP repo / impact/reviewer: `prefer_codelens_after_bootstrap` (baseline=2972, naive=400, routed=8332, confidence=high)
- Rust MCP repo / onboarding/planning: `prefer_codelens_after_bootstrap` (baseline=2621, naive=482, routed=3768, confidence=high)
...
- Rust MCP repo / simple local lookup/edit: `avoid_codelens_for_simple_local_lookup` (baseline=7761, naive=8718, routed=12068, confidence=high)
