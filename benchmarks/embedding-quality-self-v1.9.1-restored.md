...
|---|---:|---:|---:|---:|---:|
| semantic_search | 0.434 | 40% | 45% | 47% | 267.1 |
| get_ranked_context_no_semantic | 0.423 | 38% | 46% | 47% | 34.2 |
| get_ranked_context | 0.485 | 43% | 54% | 55% | 104.2 |

## Query Type Breakdown

| Method | Query type | Count | MRR | Acc@1 | Acc@3 | Acc@5 | Avg ms |
|---|---|---:|---:|---:|---:|---:|---:|
| semantic_search | identifier | 25 | 0.680 | 68% | 68% | 68% | 134.9 |
| semantic_search | natural_language | 55 | 0.321 | 27% | 35% | 38% | 336.5 |
| semantic_search | short_phrase | 9 | 0.444 | 44% | 44% | 44% | 209.6 |
| get_ranked_context_no_semantic | identifier | 25 | 0.680 | 68% | 68% | 68% | 25.7 |
| get_ranked_context_no_semantic | natural_language | 55 | 0.292 | 24% | 35% | 35% | 37.8 |
| get_ranked_context_no_semantic | short_phrase | 9 | 0.515 | 44% | 56% | 67% | 36.1 |
| get_ranked_context | identifier | 25 | 0.680 | 68% | 68% | 68% | 25.5 |
| get_ranked_context | natural_language | 55 | 0.383 | 33% | 42% | 44% | 135.2 |
| get_ranked_context | short_phrase | 9 | 0.574 | 33% | 89% | 89% | 132.8 |
