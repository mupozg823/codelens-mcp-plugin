...
|---|---:|---:|---:|---:|---:|
| semantic_search | 0.523 | 48% | 54% | 56% | 250.4 |
| get_ranked_context_no_semantic | 0.541 | 47% | 60% | 65% | 32.0 |
| get_ranked_context | 0.585 | 51% | 65% | 67% | 103.8 |

## Query Type Breakdown

| Method | Query type | Count | MRR | Acc@1 | Acc@3 | Acc@5 | Avg ms |
|---|---|---:|---:|---:|---:|---:|---:|
| semantic_search | identifier | 25 | 0.800 | 80% | 80% | 80% | 131.1 |
| semantic_search | natural_language | 55 | 0.408 | 35% | 44% | 47% | 301.8 |
| semantic_search | short_phrase | 9 | 0.458 | 44% | 44% | 44% | 267.4 |
| get_ranked_context_no_semantic | identifier | 25 | 0.800 | 80% | 80% | 80% | 22.5 |
| get_ranked_context_no_semantic | natural_language | 55 | 0.447 | 36% | 53% | 58% | 36.1 |
| get_ranked_context_no_semantic | short_phrase | 9 | 0.395 | 22% | 44% | 67% | 33.2 |
| get_ranked_context | identifier | 25 | 0.800 | 80% | 80% | 80% | 23.5 |
| get_ranked_context | natural_language | 55 | 0.490 | 40% | 55% | 58% | 135.1 |
| get_ranked_context | short_phrase | 9 | 0.574 | 33% | 89% | 89% | 135.6 |
...
| natural_language | +0.043 | +4% | +2% | +0% |
| short_phrase | +0.179 | +11% | +44% | +22% |
...
| get_ranked_context_no_semantic | move code to a different file | 18 | test_file_path_to_module_js (crates/codelens-engine/src/move_symbol.rs) |
...
| get_ranked_context_no_semantic | detect if client is Claude Code or Codex | 5 | client_profile (crates/codelens-mcp/src/state.rs) |
...
| get_ranked_context_no_semantic | filter out standard library noise from call graph | 5 | call_graph (crates/codelens-engine/src/lib.rs) |
...
| get_ranked_context_no_semantic | find all occurrences of a word in project files | miss | collect_files (crates/codelens-engine/src/project.rs) |
...
| get_ranked_context_no_semantic | classify what kind of symbol this is | 4 | make_symbol_id (crates/codelens-engine/src/symbols/types.rs) |
...
| get_ranked_context | skip comments and string literals during search | 13 | search (crates/codelens-engine/src/embedding/mod.rs) |
...
| get_ranked_context | find all occurrences of a word in project files | 9 | find_all_word_matches (crates/codelens-engine/src/rename.rs) |
