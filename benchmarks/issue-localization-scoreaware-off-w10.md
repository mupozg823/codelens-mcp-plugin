...
- Generated: `2026-08-08T13:48:16+00:00`
...
| --- | --- | --- | --- | --- | --- | --- |
| search_ranked | all | files | 0.094 | 0.521 | 0.151 | 16 |
| search_ranked | all | containers | 0.000 | 0.000 | 0.000 | 8 |
| search_ranked | all | functions | 0.067 | 0.302 | 0.101 | 15 |
| search_ranked | verbatim | files | 0.085 | 0.458 | 0.138 | 8 |
| search_ranked | verbatim | containers | 0.000 | 0.000 | 0.000 | 3 |
| search_ranked | verbatim | functions | 0.095 | 0.571 | 0.159 | 7 |
| search_ranked | descriptive | files | 0.103 | 0.583 | 0.165 | 8 |
| search_ranked | descriptive | containers | 0.000 | 0.000 | 0.000 | 5 |
| search_ranked | descriptive | functions | 0.042 | 0.067 | 0.051 | 8 |
