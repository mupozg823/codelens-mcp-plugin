...
|---|---:|---:|---:|---:|---:|
| semantic_search | 0.916 | 87% | 96% | 99% | 577.4 |
| get_ranked_context_no_semantic | 0.832 | 79% | 87% | 89% | 43.2 |
| get_ranked_context | 0.962 | 94% | 97% | 99% | 142.6 |

## Query Type Breakdown

| Method | Query type | Count | MRR | Acc@1 | Acc@3 | Acc@5 | Avg ms |
|---|---|---:|---:|---:|---:|---:|---:|
| semantic_search | natural_language | 35 | 0.898 | 86% | 94% | 97% | 577.9 |
| semantic_search | short_phrase | 35 | 0.934 | 89% | 97% | 100% | 576.8 |
| get_ranked_context_no_semantic | natural_language | 35 | 0.843 | 80% | 89% | 89% | 43.2 |
| get_ranked_context_no_semantic | short_phrase | 35 | 0.821 | 77% | 86% | 89% | 43.2 |
| get_ranked_context | natural_language | 35 | 0.960 | 94% | 97% | 97% | 141.9 |
| get_ranked_context | short_phrase | 35 | 0.964 | 94% | 97% | 100% | 143.3 |
...
|---|---|---:|---|
| semantic_search | search primary implementation | 5 | search_symbols (crates/codelens-tui/src/app.rs) |
| semantic_search | which symbol is responsible for search | miss | search_symbols (crates/codelens-tui/src/app.rs) |
| semantic_search | which Rust struct type is EmbeddingEngine and holds the ONNX model | 4 | is_static_method_ident_accepts_pascal_and_rejects_snake (crates/codelens-engine/src/embedding/mod.rs) |
