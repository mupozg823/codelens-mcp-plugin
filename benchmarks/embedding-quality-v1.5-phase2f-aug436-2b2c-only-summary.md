...
|---|---:|---:|---:|---:|---:|
| semantic_search | 0.047 | 4% | 5% | 5% | 233.5 |
| get_ranked_context_no_semantic | 0.041 | 3% | 4% | 5% | 32.3 |
| get_ranked_context | 0.049 | 4% | 5% | 6% | 118.4 |

## Query Type Breakdown

| Method | Query type | Count | MRR | Acc@1 | Acc@3 | Acc@5 | Avg ms |
|---|---|---:|---:|---:|---:|---:|---:|
| semantic_search | identifier | 83 | 0.096 | 10% | 10% | 10% | 130.1 |
| semantic_search | natural_language | 299 | 0.037 | 3% | 4% | 4% | 264.5 |
| semantic_search | short_phrase | 54 | 0.021 | 2% | 2% | 2% | 220.9 |
| get_ranked_context_no_semantic | identifier | 83 | 0.096 | 10% | 10% | 10% | 23.6 |
| get_ranked_context_no_semantic | natural_language | 299 | 0.032 | 2% | 4% | 4% | 34.6 |
| get_ranked_context_no_semantic | short_phrase | 54 | 0.005 | 0% | 0% | 2% | 33.0 |
| get_ranked_context | identifier | 83 | 0.096 | 10% | 10% | 10% | 23.5 |
| get_ranked_context | natural_language | 299 | 0.039 | 3% | 4% | 5% | 139.2 |
| get_ranked_context | short_phrase | 54 | 0.028 | 2% | 4% | 4% | 149.0 |
...
| get_ranked_context | find where a symbol is defined in a file | miss | find_symbols_by_name (crates/codelens-engine/src/db/ops.rs) |
