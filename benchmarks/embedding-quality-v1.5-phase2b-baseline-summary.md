...
|---|---:|---:|---:|---:|---:|
| semantic_search | 0.528 | 48% | 55% | 57% | 246.9 |
| get_ranked_context_no_semantic | 0.493 | 42% | 54% | 60% | 32.0 |
| get_ranked_context | 0.572 | 51% | 61% | 65% | 103.5 |

## Query Type Breakdown

| Method | Query type | Count | MRR | Acc@1 | Acc@3 | Acc@5 | Avg ms |
|---|---|---:|---:|---:|---:|---:|---:|
| semantic_search | identifier | 25 | 0.800 | 80% | 80% | 80% | 132.6 |
| semantic_search | natural_language | 55 | 0.422 | 36% | 45% | 49% | 296.8 |
| semantic_search | short_phrase | 9 | 0.421 | 33% | 44% | 44% | 259.9 |
| get_ranked_context_no_semantic | identifier | 25 | 0.800 | 80% | 80% | 80% | 22.5 |
| get_ranked_context_no_semantic | natural_language | 55 | 0.364 | 27% | 42% | 49% | 36.1 |
| get_ranked_context_no_semantic | short_phrase | 9 | 0.423 | 22% | 56% | 67% | 33.0 |
| get_ranked_context | identifier | 25 | 0.800 | 80% | 80% | 80% | 22.7 |
| get_ranked_context | natural_language | 55 | 0.471 | 40% | 49% | 55% | 135.5 |
...
| get_ranked_context | find similar code snippets using embeddings | 15 | find_similar_code (crates/codelens-engine/src/embedding/mod.rs) |
