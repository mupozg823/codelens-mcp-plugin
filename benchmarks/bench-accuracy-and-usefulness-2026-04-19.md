...
| Sampling truncation (`sampled=true`) is easy for agents (and humans) to miss, leading to false "recall gap" reports                                                                                                                                                             | Medium — observed in the original v1 of this document               | **High** — surface an explicit `sampling_notice` string (C2) |
