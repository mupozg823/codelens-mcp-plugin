...
|---|---:|---:|---:|---:|---:|
| semantic_search | 0.523 | 48% | 54% | 56% | 254.1 |
| get_ranked_context_no_semantic | 0.489 | 42% | 53% | 58% | 32.6 |
| get_ranked_context | 0.573 | 49% | 63% | 65% | 104.3 |

## Query Type Breakdown

| Method | Query type | Count | MRR | Acc@1 | Acc@3 | Acc@5 | Avg ms |
|---|---|---:|---:|---:|---:|---:|---:|
| semantic_search | identifier | 25 | 0.800 | 80% | 80% | 80% | 133.8 |
| semantic_search | natural_language | 55 | 0.408 | 35% | 44% | 47% | 306.0 |
| semantic_search | short_phrase | 9 | 0.458 | 44% | 44% | 44% | 270.7 |
| get_ranked_context_no_semantic | identifier | 25 | 0.800 | 80% | 80% | 80% | 22.9 |
| get_ranked_context_no_semantic | natural_language | 55 | 0.363 | 27% | 42% | 47% | 36.8 |
| get_ranked_context_no_semantic | short_phrase | 9 | 0.390 | 22% | 44% | 67% | 33.8 |
| get_ranked_context | identifier | 25 | 0.800 | 80% | 80% | 80% | 22.9 |
| get_ranked_context | natural_language | 55 | 0.469 | 38% | 51% | 55% | 136.5 |
| get_ranked_context | short_phrase | 9 | 0.574 | 33% | 89% | 89% | 133.2 |
...
| natural_language | +0.106 | +11% | +9% | +7% |
| short_phrase | +0.185 | +11% | +44% | +22% |
