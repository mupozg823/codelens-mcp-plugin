...
- Generated: `2026-08-08T15:11:10+00:00`
- Repo HEAD: `6b8e1cb60ff1922f518532678dede0bbc5e30208`
- Daemon: `http://127.0.0.1:7998` (clientInfo.name=`claude-code`)
...
| --- | --- | --- | --- | --- | --- | --- |
| analyze_change_request | all | files | 0.240 | 0.500 | 0.306 | 16 |
| analyze_change_request | all | containers | 0.000 | 0.000 | 0.000 | 8 |
| analyze_change_request | all | functions | 0.200 | 0.302 | 0.213 | 15 |
| analyze_change_request | verbatim | files | 0.271 | 0.583 | 0.354 | 8 |
| analyze_change_request | verbatim | containers | 0.000 | 0.000 | 0.000 | 3 |
| analyze_change_request | verbatim | functions | 0.286 | 0.571 | 0.357 | 7 |
| analyze_change_request | descriptive | files | 0.208 | 0.417 | 0.258 | 8 |
| analyze_change_request | descriptive | containers | 0.000 | 0.000 | 0.000 | 5 |
| analyze_change_request | descriptive | functions | 0.125 | 0.067 | 0.087 | 8 |
| search_ranked | all | files | 0.143 | 0.667 | 0.220 | 16 |
| search_ranked | all | containers | 0.000 | 0.000 | 0.000 | 8 |
| search_ranked | all | functions | 0.138 | 0.347 | 0.144 | 15 |
| search_ranked | verbatim | files | 0.159 | 0.792 | 0.250 | 8 |
| search_ranked | verbatim | containers | 0.000 | 0.000 | 0.000 | 3 |
| search_ranked | verbatim | functions | 0.133 | 0.667 | 0.212 | 7 |
| search_ranked | descriptive | files | 0.126 | 0.542 | 0.190 | 8 |
| search_ranked | descriptive | containers | 0.000 | 0.000 | 0.000 | 5 |
| search_ranked | descriptive | functions | 0.143 | 0.067 | 0.083 | 8 |

| surface | class | file hit@1 | file hit@3 | queries |
| --- | --- | --- | --- | --- |
| analyze_change_request | all | 0.250 | 0.625 | 16 |
| analyze_change_request | verbatim | 0.250 | 0.750 | 8 |
| analyze_change_request | descriptive | 0.250 | 0.500 | 8 |
| search_ranked | all | 0.250 | 0.625 | 16 |
| search_ranked | verbatim | 0.250 | 0.750 | 8 |
| search_ranked | descriptive | 0.250 | 0.500 | 8 |

## Per-query misses

### analyze_change_request

- `Q01` (verbatim, `00a6289a`) — right crate, wrong module. Missing ['crates/codelens-mcp/src/tool_defs/presets.rs']; predicted top-3 ['crates/codelens-mcp/src/tools/admin/mod.rs', 'crates/codelens-engine/src/symbols/writer.rs', 'crates/codelens-mcp/src/tools/symbols/inventory.rs']
- `Q03` (verbatim, `44edfce4`) — right module, wrong file. Missing ['crates/codelens-mcp/src/artifact_store.rs', 'crates/codelens-mcp/src/job_store.rs']; predicted top-3 ['crates/codelens-mcp/src/tools/symbol_query/retrieval_scope.rs', 'crates/codelens-mcp/src/util.rs', 'crates/codelens-engine/src/scope_analysis.rs']
- `Q05` (descriptive, `f963b31a`) — right crate, wrong module. Missing ['crates/codelens-engine/src/db/mod.rs']; predicted top-3 ['crates/codelens-engine/src/symbols/writer.rs', 'crates/codelens-engine/src/symbols/mod.rs', 'crates/codelens-mcp/src/agent_coordination.rs']
- `Q06` (verbatim, `d3cb909f`) — right crate, wrong module. Missing ['crates/codelens-mcp/src/tool_defs/generated/build_generated.rs', 'crates/codelens-mcp/src/tools/report_jobs.rs']; predicted top-3 ['crates/codelens-mcp/src/tools/reports/impact_reports/boundary.rs', 'crates/codelens-mcp/src/tools/report_jobs/runners.rs', 'crates/codelens-mcp/src/tools/reports/impact_reports/refactor.rs']
...
- `Q03` (verbatim, `44edfce4`) — right module, wrong file. Missing ['crates/codelens-mcp/src/job_store.rs']; predicted top-3 ['crates/codelens-mcp/src/tools/symbol_query/retrieval_scope.rs', 'crates/codelens-mcp/src/util.rs', 'crates/codelens-engine/src/scope_analysis.rs']
- `Q06` (verbatim, `d3cb909f`) — right crate, wrong module. Missing ['crates/codelens-mcp/src/tool_defs/generated/build_generated.rs']; predicted top-3 ['crates/codelens-mcp/src/tools/reports/impact_reports/boundary.rs', 'crates/codelens-mcp/src/tools/report_jobs/runners.rs', 'crates/codelens-mcp/src/tools/reports/impact_reports/refactor.rs']
- `Q07` (verbatim, `45b76f38`) — right crate, wrong module. Missing ['crates/codelens-mcp/src/integration_tests/workflow/harness.rs']; predicted top-3 ['crates/codelens-mcp/src/tools/session/project_ops/prepare_harness/warnings/index.rs', 'crates/codelens-mcp/src/tools/session/metrics_config/health.rs', 'crates/codelens-engine/src/memory/policy.rs']
- `Q09` (descriptive, `cf8e4e63`) — right crate, wrong module. Missing ['crates/codelens-mcp/src/agent_coordination.rs']; predicted top-3 ['crates/codelens-engine/src/db/mod.rs', 'crates/codelens-engine/src/symbols/mod.rs', 'crates/codelens-mcp/src/state/project_runtime_lease.rs']
