...
|---|---:|---:|---:|---:|---:|
| semantic_search | 0.515 | 47% | 54% | 57% | 263.7 |
| get_ranked_context_no_semantic | 0.477 | 43% | 51% | 55% | 33.3 |
| get_ranked_context | 0.566 | 48% | 64% | 66% | 153.6 |

## Query Type Breakdown

| Method | Query type | Count | MRR | Acc@1 | Acc@3 | Acc@5 | Avg ms |
|---|---|---:|---:|---:|---:|---:|---:|
| semantic_search | identifier | 25 | 0.800 | 80% | 80% | 80% | 197.5 |
| semantic_search | natural_language | 55 | 0.397 | 33% | 44% | 49% | 299.6 |
| semantic_search | short_phrase | 9 | 0.444 | 44% | 44% | 44% | 227.7 |
| get_ranked_context_no_semantic | identifier | 25 | 0.800 | 80% | 80% | 80% | 25.1 |
| get_ranked_context_no_semantic | natural_language | 55 | 0.324 | 25% | 36% | 42% | 36.8 |
| get_ranked_context_no_semantic | short_phrase | 9 | 0.515 | 44% | 56% | 67% | 34.6 |
| get_ranked_context | identifier | 25 | 0.800 | 80% | 80% | 80% | 26.4 |
| get_ranked_context | natural_language | 55 | 0.459 | 36% | 53% | 56% | 188.5 |
| get_ranked_context | short_phrase | 9 | 0.574 | 33% | 89% | 89% | 293.5 |
...
| natural_language | +0.135 | +11% | +16% | +15% |
