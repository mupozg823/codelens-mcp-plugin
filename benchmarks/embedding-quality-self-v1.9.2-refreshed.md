...
|---|---:|---:|---:|---:|---:|
| semantic_search | 0.582 | 53% | 62% | 65% | 227.2 |
| get_ranked_context_no_semantic | 0.557 | 49% | 61% | 64% | 31.7 |
| get_ranked_context | 0.654 | 56% | 72% | 78% | 100.5 |

## Query Type Breakdown

| Method | Query type | Count | MRR | Acc@1 | Acc@3 | Acc@5 | Avg ms |
|---|---|---:|---:|---:|---:|---:|---:|
| semantic_search | identifier | 25 | 0.960 | 96% | 96% | 96% | 141.9 |
| semantic_search | natural_language | 55 | 0.427 | 35% | 47% | 53% | 268.8 |
| semantic_search | short_phrase | 9 | 0.481 | 44% | 56% | 56% | 209.4 |
| get_ranked_context_no_semantic | identifier | 25 | 0.960 | 96% | 96% | 96% | 24.6 |
| get_ranked_context_no_semantic | natural_language | 55 | 0.372 | 29% | 42% | 47% | 34.9 |
| get_ranked_context_no_semantic | short_phrase | 9 | 0.561 | 44% | 78% | 78% | 32.1 |
| get_ranked_context | identifier | 25 | 0.960 | 96% | 96% | 96% | 23.8 |
| get_ranked_context | natural_language | 55 | 0.510 | 40% | 56% | 65% | 131.0 |
| get_ranked_context | short_phrase | 9 | 0.685 | 44% | 100% | 100% | 126.9 |
...
| natural_language | +0.137 | +11% | +15% | +18% |
...
| semantic_search | find similar code snippets using embeddings | 5 | find_similar_code (crates/codelens-engine/src/embedding/mod.rs) |
