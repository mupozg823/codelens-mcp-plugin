...
|---|---:|---:|---:|---:|---:|
| semantic_search | 0.689 | 65% | 74% | 74% | 535.3 |
| get_ranked_context_no_semantic | 0.583 | 53% | 65% | 65% | 44.6 |
| get_ranked_context | 0.712 | 68% | 75% | 75% | 120.2 |

## Query Type Breakdown

| Method | Query type | Count | MRR | Acc@1 | Acc@3 | Acc@5 | Avg ms |
|---|---|---:|---:|---:|---:|---:|---:|
| semantic_search | identifier | 31 | 0.935 | 94% | 94% | 94% | 182.2 |
| semantic_search | natural_language | 62 | 0.556 | 52% | 61% | 61% | 692.3 |
| semantic_search | short_phrase | 11 | 0.742 | 64% | 91% | 91% | 645.6 |
| get_ranked_context_no_semantic | identifier | 31 | 0.935 | 94% | 94% | 94% | 31.4 |
| get_ranked_context_no_semantic | natural_language | 62 | 0.435 | 37% | 52% | 52% | 50.8 |
| get_ranked_context_no_semantic | short_phrase | 11 | 0.424 | 27% | 64% | 64% | 47.0 |
| get_ranked_context | identifier | 31 | 0.935 | 94% | 94% | 94% | 31.7 |
| get_ranked_context | natural_language | 62 | 0.594 | 56% | 63% | 63% | 157.8 |
| get_ranked_context | short_phrase | 11 | 0.742 | 64% | 91% | 91% | 157.8 |
...
| get_ranked_context | record which files were recently accessed | miss | recent_file_paths (crates/codelens-mcp/src/state.rs) |
