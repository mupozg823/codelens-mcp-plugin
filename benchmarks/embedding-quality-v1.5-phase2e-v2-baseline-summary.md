...
|---|---:|---:|---:|---:|---:|
| semantic_search | 0.528 | 48% | 55% | 57% | 246.5 |
| get_ranked_context_no_semantic | 0.489 | 42% | 53% | 58% | 31.4 |
| get_ranked_context | 0.572 | 51% | 61% | 65% | 102.6 |

## Query Type Breakdown

| Method | Query type | Count | MRR | Acc@1 | Acc@3 | Acc@5 | Avg ms |
|---|---|---:|---:|---:|---:|---:|---:|
| semantic_search | identifier | 25 | 0.800 | 80% | 80% | 80% | 130.5 |
| semantic_search | natural_language | 55 | 0.422 | 36% | 45% | 49% | 296.9 |
| semantic_search | short_phrase | 9 | 0.421 | 33% | 44% | 44% | 260.7 |
| get_ranked_context_no_semantic | identifier | 25 | 0.800 | 80% | 80% | 80% | 22.3 |
| get_ranked_context_no_semantic | natural_language | 55 | 0.363 | 27% | 42% | 47% | 35.3 |
| get_ranked_context_no_semantic | short_phrase | 9 | 0.390 | 22% | 44% | 67% | 32.4 |
| get_ranked_context | identifier | 25 | 0.800 | 80% | 80% | 80% | 22.4 |
| get_ranked_context | natural_language | 55 | 0.470 | 40% | 49% | 55% | 134.2 |
| get_ranked_context | short_phrase | 9 | 0.559 | 33% | 78% | 89% | 132.5 |
...
| natural_language | +0.107 | +13% | +7% | +7% |
| short_phrase | +0.170 | +11% | +33% | +22% |
...
| get_ranked_context_no_semantic | collect rename edits scoped to a single file | 6 | rename_symbol (crates/codelens-engine/src/rename.rs) |
| get_ranked_context_no_semantic | search for a symbol by name | 5 | parse_symbol_id (crates/codelens-engine/src/symbols/types.rs) |
...
| get_ranked_context | find where a symbol is defined in a file | 5 | find_symbol (crates/codelens-engine/src/symbols/mod.rs) |
