...
|---|---:|---:|---:|---:|---:|
| semantic_search | 0.435 | 40% | 45% | 47% | 307.3 |
| get_ranked_context_no_semantic | 0.423 | 38% | 46% | 47% | 34.0 |
| get_ranked_context | 0.485 | 43% | 54% | 55% | 156.2 |

## Query Type Breakdown

| Method | Query type | Count | MRR | Acc@1 | Acc@3 | Acc@5 | Avg ms |
|---|---|---:|---:|---:|---:|---:|---:|
| semantic_search | identifier | 25 | 0.680 | 68% | 68% | 68% | 138.9 |
| semantic_search | natural_language | 55 | 0.321 | 27% | 35% | 38% | 384.5 |
| semantic_search | short_phrase | 9 | 0.444 | 44% | 44% | 44% | 303.7 |
| get_ranked_context_no_semantic | identifier | 25 | 0.680 | 68% | 68% | 68% | 26.0 |
| get_ranked_context_no_semantic | natural_language | 55 | 0.292 | 24% | 35% | 35% | 37.4 |
| get_ranked_context_no_semantic | short_phrase | 9 | 0.515 | 44% | 56% | 67% | 35.4 |
| get_ranked_context | identifier | 25 | 0.680 | 68% | 68% | 68% | 27.6 |
| get_ranked_context | natural_language | 55 | 0.383 | 33% | 42% | 44% | 217.9 |
| get_ranked_context | short_phrase | 9 | 0.574 | 33% | 89% | 89% | 136.3 |
...
| semantic_search | change function parameters | miss | same_name_returns_no_changes (crates/codelens-engine/src/rename.rs) |
...
| semantic_search | check if a tool requires preflight verification | miss | record_mutation_without_preflight (crates/codelens-mcp/src/telemetry.rs) |
...
| get_ranked_context_no_semantic | watch filesystem for file changes | miss | index_files_with_retry (crates/codelens-engine/src/watcher.rs) |
