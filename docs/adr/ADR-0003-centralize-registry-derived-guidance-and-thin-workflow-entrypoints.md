...
4. Reduce manual snapshot drift in `README.md` and `docs/architecture.md`. **Partial** — snapshots were manually refreshed this cycle; automation remains a follow-up if drift reappears.
