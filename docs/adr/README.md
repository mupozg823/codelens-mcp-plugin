...
| [ADR-0005](ADR-0005-harness-v2.md)                                             | Role-Specialized Host Harness — CodeLens as Shared Substrate               | **Accepted**                     | 2026-04-18 | —                    |
| [ADR-0006](ADR-0006-agent-routing-enforcement.md)                              | Agent Routing Enforcement (legacy executor metadata)                       | Deprecated                       | 2026-04-18 | Host-neutral contract in #389 |
