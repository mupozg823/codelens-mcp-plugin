...
| [ADR-0005](ADR-0005-harness-v2.md)                                             | Shared Harness Substrate for Host-Selected Roles                           | **Accepted**                     | 2026-04-18 | —                    |
| [ADR-0006](ADR-0006-agent-routing-enforcement.md)                              | Agent Routing Enforcement (legacy executor metadata)                       | Deprecated by ADR-0015           | 2026-04-18 | —                    |
...
| [ADR-0010](0010-telemetry-driven-tool-diet.md)                                 | Telemetry-Driven Tool Surface Diet                                         | Partly implemented                         | 2026-04-30 | —                    |
