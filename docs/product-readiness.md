...
2. Expand ranker benchmarks to 300-500 labeled rows, attach the already-pinned
   `/tmp/codelens-embedding-quality-triage.json` shape to CI/release evidence,
   and reduce p95 response tokens.
