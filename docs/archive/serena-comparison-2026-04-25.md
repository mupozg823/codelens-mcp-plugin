# CodeLens vs Serena (archived 2026-04-25 revision)

> **Archived 2026-06-10.** This is the 2026-04-25 revision, superseded by
> [`docs/serena-comparison.md`](../serena-comparison.md) which re-audits against Serena v1.5.3.
> Kept for the Phase A-E roadmap framing and the completion estimates of that date.
