...
- Roles:
  - `solo-agent`: `readonly` (40), `builder` (41); mutate=`false`; one session handles both planning and implementation
- Recommended flow:
...
- Roles:
  ...
  - `builder-refactor`: `builder` (41), `builder` (41); mutate=`true`; execute bounded edits after preflight, diagnostics, and claims
- Recommended flow:
  - `prepare_harness_session`
